...
def cadastrar_oferta():
    ...
    if request.method == "POST":
        ...
        oferta = OfertaTroca(colecionador_id=colecionador_id, observacao=observacao)
        oferta.itens.append(ItemOferta(figurinha_id=figurinha_oferece_id, tipo="oferece"))
        oferta.itens.append(ItemOferta(figurinha_id=figurinha_deseja_id, tipo="deseja"))
